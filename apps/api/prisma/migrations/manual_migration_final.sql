...
-- Create clients table (lowercase to match existing naming convention)
...
CREATE UNIQUE INDEX IF NOT EXISTS "time_allocations_tenant_id_project_id_employee_id_year_month_key"
...
CREATE UNIQUE INDEX IF NOT EXISTS "project_budgets_tenant_id_project_id_year_month_key"
